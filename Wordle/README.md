...
<ul>
  <li><img src="Image/CorrectLoc.png" width="50" alt="letter in correct location"> 
Letter is in word, and is in the correct location.</li>
  <li><img src="Image/IncorrectLoc.png" width="50" alt="letter in incorrect location"> Letter is in word, but is in the incorrect location.</li>
  <li><img src="Image/Incorrect.png" width="50" alt="incorrect letter"> Letter is not in word.</li>
</ul>
